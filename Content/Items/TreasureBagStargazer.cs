...
{
	public class TreasureBagStargazer : ModItem
	{
        /*
        ...
        */
        ...
        {
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<Tesseract>()));

            itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(ModContent.NPCType<Stargazer>()));
        }
    }	
}
