...
{ 
	...
	public class AntimatterLeggings : ModItem
	{
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
        {
            Texture2D texture = ModContent.Request<Texture2D>("AftermathMod/Content/Items/Armor/AntimatterLeggings_glow", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
		...
		{
			player.moveSpeed += 0.6f; //=60%
			player.jumpSpeedBoost += 2f; //=40%
		}
