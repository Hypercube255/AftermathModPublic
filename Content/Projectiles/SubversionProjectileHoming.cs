...
{
    public class SubversionProjectileHoming : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Projectile.velocity = Projectile.velocity.ToRotation().AngleTowards(TargetAngle, MathHelper.ToRadians(7)).ToRotationVector2() * LengthOrgnl;
