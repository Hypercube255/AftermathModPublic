...
{
	public class I1SFlamethrowerFriendly : ModProjectile
	{
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                float TrailSize = MathHelper.Lerp(OriginalSize, 0.5f, i / ProjectileID.Sets.TrailCacheLength[Projectile.type]);
